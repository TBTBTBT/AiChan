...
struct  ClientSessionInfo_t717  : public Object_t
{
	...
	ByteU5BU5D_t623* ___sid_4;
	// System.Byte[] Mono.Security.Protocol.Tls.ClientSessionInfo::masterSecret
	ByteU5BU5D_t623* ___masterSecret_5;
};
struct ClientSessionInfo_t717_StaticFields{
