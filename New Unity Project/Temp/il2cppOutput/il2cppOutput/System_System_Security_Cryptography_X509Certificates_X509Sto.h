...
struct  X509Store_t891  : public Object_t
{
	...
	X509Certificate2Collection_t885 * ___list_2;
	...
	X509Store_t690 * ___store_4;
};
struct X509Store_t891_StaticFields{
	...
	Dictionary_2_t194 * ___U3CU3Ef__switchU24mapF_5;
};
