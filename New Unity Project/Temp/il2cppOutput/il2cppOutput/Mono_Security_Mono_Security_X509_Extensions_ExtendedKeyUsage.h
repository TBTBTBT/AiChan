...
struct  ExtendedKeyUsageExtension_t695  : public X509Extension_t689
{
	// System.Collections.ArrayList Mono.Security.X509.Extensions.ExtendedKeyUsageExtension::keyPurpose
	ArrayList_t654 * ___keyPurpose_3;
};
struct ExtendedKeyUsageExtension_t695_StaticFields{
	...
	Dictionary_2_t194 * ___U3CU3Ef__switchU24map14_4;
};
